...
Status: Draft. Owners: Organization lead and security architect. Related: [permissions](../architecture/permissions-matrix.md), [ADR 0002](../adr/0002-church-id.md), [ADR 0003](../adr/0003-identity-and-scoped-authorization.md).
